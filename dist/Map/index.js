...
exports.Map = props => {
  ...
  return react_1.default.createElement(
    api_1.GoogleMap,
    {mapContainerClassName: className, center: coordinates, zoom: zoom, options: options},
    react_1.default.createElement(Warehouse_1.Warehouse, {
      warehouseTypesData: warehouseTypesData,
      warehouse: warehouse,
      onClose: onClose,
    }),
    react_1.default.createElement(
      api_1.MarkerClusterer,
      {
        options: {
      ...
      clusterer =>
        warehouseData.map(warehouse =>
          react_1.default.createElement(Marker_1.MemoMarker, {
            key: warehouse.Ref,
            position: {
